<?php    
	...
	if ($_GET["data"] == "get_user") {
		...
		while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
			...
			$user[]  = array($row["id"],$row["username"],$row["password"],$row["image"],$role,$row["email"],$row["createdAt"]);
		}
	...
	if($_GET["data"] == "add_user"){
		...
		$sql = "INSERT INTO user (username, password,image,role,email) VALUES (:username, :password,:image ,:role,:email)";
