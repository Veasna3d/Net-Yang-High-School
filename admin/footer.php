            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">បាតកថា</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">បាតកថា</h5>
                ...
                <form method="post" id="form">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="" name="youtube" id="youtube" class="form-control" />
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" id="btnSave">រក្សាទុក</button>
